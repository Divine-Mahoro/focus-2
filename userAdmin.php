...
<body onclick="console.log('body clicked')">
            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li><a href="<?php echo $main_link; ?>?dir=calender&page=timeTable" aria-expanded="false"><i
                                class="bi-shop"></i><span class="nav-text">Timetable<span class="badge badge-warning ml-1"><?php echo $resultSold; ?></span></span></a></li>
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="<?php echo $main_link; ?>?dir=Admin&page=createSemester" id="roleChange">Create Semester</a></li>
                            <li><a href="<?php echo $main_link; ?>?dir=Admin&page=lockUser">Lock User</a></li>
							<li><a href="#">Review Registered Data</a></li>
							<li><a href="<?php echo $main_link; ?>?dir=Admin&page=resetUserPassword">Reset Password</a></li>
							<li><a href="<?php echo $main_link; ?>?dir=Admin&page=reportLink">Report Link</a></li>
                        </ul>
                    </li>			
  ...
  $(document).ready(function(){
	...
	$(".donede").click(function(){
		alert("Reaching here btn");
		var $el = $(this).closest('tr');
		//var course = $el.find(".crs_data").val();
		var course = $("#crs_data").val();
		alert(course);
		$.ajax({
			url: 'attandance_to_excel.php',
			method: 'POST',
			data: {course:course},
			dataType: 'JSON',
