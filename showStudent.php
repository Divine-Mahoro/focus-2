            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li><a href="<?php echo $main_link; ?>?dir=attandance&page=attandancePage" aria-expanded="false"><i
                                class="bi-shop"></i><span class="nav-text">Current Class<span class="badge badge-warning ml-1"><?php echo $resultSold; ?></span></span></a></li>
					<li><a href="<?php echo $main_link; ?>?dir=courses&page=allCourses&action=all" aria-expanded="false"><i
		...
		<div class="content-body">
            ...
            <?php
					if(isset($_GET["course"])){
						...
						$id = $_GET["id"];
						$result = "{$user}-{$id}";
						$foundExplode = explode('-',$result);
						$userExplode = $foundExplode[0];
						$couExplode = $foundExplode[1];
						$edit_qry = "SELECT course_name FROM teacher_courses
									 WHERE teacher_courses_id ='".$couExplode."'";
