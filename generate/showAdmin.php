...
if(isset($_SESSION['Admin'])){
	echo "I reach here";
  $register_user_ID = $_SESSION['Admin'];
...
if(isset($_GET["action"]) and $_GET["action"]=="allCourse"){
	include("pages/courses/allCourses");
}
    ...
    ***********************************-->
    <div id="main-wrapper">
            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li><a href="<?php echo $main_link; ?>?dir=courses&page=allCourses&action=allCourse" aria-expanded="false"><i
                                class="bi-cash-coin"></i><span class="nav-text">Courses<span class="badge badge-warning ml-1"><?php echo $resultBusiness; ?></span></span></a></li>
					<li><a href="<?php echo $main_link; ?>?dir=attandance&page=attandancePage" aria-expanded="false"><i
                                class="bi-shop"></i><span class="nav-text">Attandance<span class="badge badge-warning ml-1"><?php echo $resultSold; ?></span></span></a></li>
					<li><a href="<?php echo $main_link; ?>?dir=courses&page=allCourses&action=allCourse" aria-expanded="false"><i
                                class="bi-shop"></i><span class="nav-text">My Attandance<span class="badge badge-warning ml-1"><?php echo $resultSold; ?></span></span></a></li>
					<li><a href="<?php echo $main_link; ?>?dir=attandance&page=attandancePage" aria-expanded="false"><i
                                class="bi-shop"></i><span class="nav-text">Generate QR Attandance<span class="badge badge-warning ml-1"><?php echo $resultSold; ?></span></span></a></li>
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-single-04"></i><span class="nav-text">Links</span></a>
                        <ul aria-expanded="false">
                            <li><a href="<?php echo $main_link; ?>?dir=Admin&page=addingRole" id="roleChange">Create Semester</a></li>
                            <li><a href="<?php echo $main_link; ?>?dir=Admin&page=sendingEmailForm">Lock User</a></li>
							<li><a href="<?php echo $main_link; ?>?dir=Admin&page=createPeriod">Review Registered Data</a></li>
							<li><a href="<?php echo $main_link; ?>?dir=Admin&page=resetPasswordAdmin">Reset Password</a></li>
							<li><a href="<?php echo $main_link; ?>?dir=Admin&page=adminLink">Admin Link</a></li>
                        </ul>
                    </li>			
		...
		<div class="content-body">
            ...
            <?php
					if(isset($_GET["course"])){
						$id = $_GET["course"];
						$edit_qry = "SELECT course_name FROM teacher_courses
									 WHERE teacher_courses_id ='".$id."'";
						...
						include("pages/generateQr/qrCourse");
					}
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed for <a href="#" target="_blank">Quality Assurance</a> 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
