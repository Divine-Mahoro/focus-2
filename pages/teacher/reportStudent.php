											...
											<div class="col-auto mb-2">
												<select class="custom-select mr-sm-2" name="course" id="course">
													 ...
													 <?php 
															...
															foreach($dbh->query("SELECT * FROM teacher_courses where register_user_ID ='$register_user_ID'") as $e){
					...
					<div class="col-xl-12 col-xxl-12">
						<?php 
							if(isset($_POST['btnSubmit'])){
								...
								$query = "select COURSE_NAME, register_user_ID, STUDNAME, course_id from register_course where course_id  = '".$course."' 
								and register_user_ID not in(select DISTINCT register_user_ID from teacher_attandance where teacher_courses_id = '".$course."') 
								and register_user_ID not in (select DISTINCT register_user_ID from report_students where teacher_courses_id = '".$course."')";
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List of Unattended Student in <?php echo $course_name; ?></h4>
                            </div>
                            <?php 
													...
													<?php 
														...
														while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
															...
															if($main_link == 'userHod'){
																echo '<a href="saveReportStudentHod?student='.$id.'&course='.$course.'"><span class="badge badge-success">Report</span></i></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>';
															}
															else {
																echo '<a href="saveReportStudent?student='.$id.'&course='.$course.'"><span class="badge badge-success">Report</span></i></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>';
															}echo '</tr>';
															$i++;
														}
