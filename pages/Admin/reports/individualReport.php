																	...
																	<tbody>
																		<?php 
																			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
																				...
																				$descId = $row["immovable_asset_id"];
																				echo '<tr>';
																				echo '<td style="color:black">'.getFieldValueById("description", "immovable_assets", $descId).'</td>';
																				if($row["asset_owner_id "] == 1){
																					echo '<td style="color:black">My self</td>';
																				} else if ($row["asset_owner_id "] == 2){
																					echo '<td style="color:black">Children under ages 18</td>';
																				}
																				else {
																					echo '<td style="color:black">Spouse</td>';
																				}
																				...
																				echo '<td style="color:black">'.$row["upi"].'</td>';
																	...
																	<tbody>
																		<?php 
																			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
																				...
																				echo '<tr>';
																				echo '<td style="color:black">'.$row["livestock_type"].'</td>';
																				echo '<td style="color:black">'.$row["brand"].'</td>';
																				echo '<td style="color:black">'.$row["number"].'</td>';
																				if($row["asset_owner_id "] == 1){
																					echo '<td style="color:black">My self</td>';
																				} else if ($row["asset_owner_id "] == 2){
																					echo '<td style="color:black">Children under ages 18</td>';
																				...
																				echo '<td style="color:black">'.$row["estimated_value"].'</td>';
																				echo '<td style="color:black">'.$row["asset_source"].'</td>';
																				echo '<td style="color:black">'.$row["date_of_acquisition"].'</td>';
																				echo '<td style="color:black">'.$row["joint_asset"].'</td>';
																				echo '<td style="color:black">'.$row["percentage_of_shares"].'</td>';
																				echo '<td style="color:black">'.$row["is_bought"].'</td>';
																				echo '<td style="color:black">'.$row["seller_name"].'</td>';
																	...
																	<tbody>
																		<?php 
																			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
																				...
																				echo '<tr>';
																				echo '<td style="color:black">'.$row["vehicle_type"].'</td>';
																				echo '<td style="color:black">'.$row["plate_no"].'</td>';
																				echo '<td style="color:black">'.$row["vehicle_value"].'</td>';
																				if($row["asset_owner_id "] == 1){
																					echo '<td style="color:black">My self</td>';
																				} else if ($row["asset_owner_id "] == 2){
																					echo '<td style="color:black">Children under ages 18</td>';
																	...
																	<tbody>
																		<?php 
																			while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
																				...
																				echo '<td style="color:black">'.$row["share_amount"].'</td>';
																				echo '<td style="color:black">'.$row["tin"].'</td>';
																				if($row["asset_location_id"] == 1){
																					echo '<td style="color:black">Rwanda</td>';
																				} else {
																					echo '<td style="color:black">Abroad</td>';
                                        ...
                                        <div id="sold" class="collapse accordion__body" data-parent="#accordion-one">
                                            <div class="accordion__body--text">
												...
												<div class="col-lg-12">
													...
													<div class="card">
														<div class="card-header">
															<h4 class="card-title">Sold Asset</h4>
														</div>
														<div class="card-body">
															<?php if($stmt->rowCount() > 0){ ?>
															<div class="table-responsive">
													...
													<div class="card">
														...
														<div class="card-body">
															<div class="form-group">
																<p style="color:black">I had Checked the box for accepting the use of all Submitted i as per required by Quality Assurance to check everthing related to the information you had provided
