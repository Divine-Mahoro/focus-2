<?php 
	if(isset($_GET['edit'])){
		$id = $_GET['edit'];
		$qryEdit = "SELECT * FROM declaration_periods WHERE declaration_period_id='".$id."'";
		...
		$qryUpd = "UPDATE declaration_periods 
				   SET start_date='".$start_date."', end_date='".$end_date."' 
				   WHERE declaration_period_id = '".$declaration_period_id."'";
		...
		$yearOfDec = date("Y");
		$qry = "INSERT INTO declaration_periods(
					start_date,
					end_date,
					year
					) VALUES (
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
								<div class="basic-form">
									...
									<form action="<?php echo $main_link; ?>?dir=Admin&page=createPeriod" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
                                        <div class="form-row">
											...
											<input type="hidden" name="declaration_period_id" value="<?php echo $declaration_period_id; ?>" />
									...
									<?php 
									$currYear = date("Y");
									$query = "SELECT * FROM declaration_periods WHERE year >= ".$currYear;
									echo '<ul>';
									foreach($dbh->query($query) as $p){
										$pid = $p["declaration_period_id"];
										...
										echo '<span class=" ml-2 p-1 label label-default rounded"><a href="'.$main_link.'?dir=Admin&page=createPeriod&edit='.$pid.'&action=edit" style="color: #345;">MODIFY</a></span>';
										echo '</li>';
									}
									echo '</ul>';
									?>
