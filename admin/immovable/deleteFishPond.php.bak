...
if (intval($_GET['delete']) == 0) {
    ...
    echo "<meta http-equiv='refresh' content='0;url=../../staff.php?dir=immovable&page=brickyard&immovable_asset_id=7&error_msg=".$msg."'>";
} else {
    $id=$_GET['delete'];
    ...
    if($stmt->execute()){
		...
		echo "<meta http-equiv='refresh' content='0;url=../../staff.php?dir=immovable&page=brickyard&immovable_asset_id=7&success_msg=".$msg."'>";
    } else {
