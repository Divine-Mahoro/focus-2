...
?>
				...
				if(isset($_GET["action"]) and $_GET["action"]="add"){
					include("pages/immovable/forms/minesForm.php");
                    ...
                    <div class="col-xl-6 col-xxl-12"> 
								...
								<div class="col-12">
									...
									<div class="card-body">
										...
										<div><span class="pull-right btn btn-primary"><a href="<?php echo $main_link; ?>?dir=immovable&page=mines&action=add"> Add</a></span></div>
                                        ...
                                        <tbody>
											<?php 
												while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
													...
													echo '<td>';
													echo '<a href="staff.php?dir=immovable&page=mines&rid='.$id.'" data-toggle="modal" data-target="#viewResidential"><span class="dModalId">view</span></a>&nbsp;&nbsp;&nbsp;&nbsp;';
													if($main_link == 'staff.php'){
														echo '<a href="editMine.php?edit='.$id.'"><i class="fa fa-pencil text-dark" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
													}else{
														echo '<a href="editMineUser.php?edit='.$id.'"><i class="fa fa-pencil text-dark" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
													}
													echo '<a href="./pages/immovable/deleteMines.php?delete='.$id.'" onclick="return confirm(\'Are you sure you want to delete this record?\');"><i class="fa fa-trash text-danger" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';													
													echo '</td>';
													echo '</tr>';
												}
								...
								<?php
										...
										echo '<div><span class="pull-right btn btn-primary"><a href="'.$main_link.'?dir=immovable&page=mines&action=add"> Add</a></span></div>';
									   ...
									   <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Mines Data view</h5>
