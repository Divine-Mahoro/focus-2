                    ...
                    <div class="col-xl-6 col-xxl-12"> 
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Mines Declaration</h4>
								<?php 
                            ...
                            <div class="card-body">
								...
								<?php if($main_link == 'staffUser.php'){ ?>
                                    <form action="editMineUser.php" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
								<?php } else { ?>
									<form action="editMine.php" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
								<?php } ?>
                                        <div class="form-row">
