                    ...
                    <div class="col-xl-6 col-xxl-12"> 
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Quarry Declaration</h4>
								<?php 
                            ...
                            <div class="card-body">
								...
								<?php if($main_link == 'staffUser.php'){ ?>
                                    <form action="editBrickyardUser.php" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
								<?php } else { ?>
									<form action="editBrickyard.php" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
								<?php } ?>
                                        <div class="form-row">
