...
?>
				...
				if(isset($_GET["action"]) and $_GET["action"]="add"){
					include("pages/immovable/forms/quarryForm.php");
                    ...
                    <div class="col-xl-6 col-xxl-12"> 
								...
								<div class="col-12">
									...
									<div class="card-body">
										...
										<div><span class="pull-right btn btn-primary"><a href="<?php echo $main_link; ?>?dir=immovable&page=quarry&action=add"> Add</a></span></div>
											...
											<?php 
												while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
													...
													if($main_link == 'staff.php'){
														echo '<a href="editQuarry.php?edit='.$id.'"><i class="fa fa-pencil text-dark" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
													}else{
														echo '<a href="editQuarryUser.php?edit='.$id.'"><i class="fa fa-pencil text-dark" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
													}
													echo '<a href="./pages/immovable/deleteQuarry.php?delete='.$id.'" onclick="return confirm(\'Are you sure you want to delete this record?\');"><i class="fa fa-trash text-danger" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';													
													echo '</td>';
													echo '</tr>';
												}
									   ...
									   <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Quarry Data view</h5>
