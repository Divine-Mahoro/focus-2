...
if (intval($_GET['delete']) == 0) {
    ...
    echo "<meta http-equiv='refresh' content='0;url=../../staff.php?dir=immovable&page=quarry&immovable_asset_id=6&error_msg=".$msg."'>";
} else {
    $id=$_GET['delete'];
    ...
    if($stmt->execute()){
		...
		echo "<meta http-equiv='refresh' content='0;url=../../staff.php?dir=immovable&page=quarry&immovable_asset_id=6&success_msg=".$msg."'>";
    } else {
