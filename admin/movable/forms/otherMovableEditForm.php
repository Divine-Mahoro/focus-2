                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
								...
								<?php if($main_link == 'staffUser.php'){ ?>
                                    <form action="editOtherMovableUser.php" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
								<?php } else { ?>
									<form action="editOtherMovable.php" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
								<?php } ?>
                                        <div class="form-row">

											<div class="form-group col-md-4">
												<input type="text" class="form-control" name="movable_type" id="movable_type" value="<?php echo $movable_type; ?>">
										   	</div>
										...
										<input type="hidden" name="other_movable_declaration_id" value="<?php echo $other_movable_declaration_id; ?>" />
