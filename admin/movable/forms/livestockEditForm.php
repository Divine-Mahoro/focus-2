                    ...
                    <div class="col-xl-6 col-xxl-12"> 
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Livestock Declaration</h4>
								<?php 
                            ...
                            <div class="card-body">
								...
								<?php if($main_link == 'staffUser.php'){ ?>
                                    <form action="editLivestockUser.php" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
								<?php } else { ?>
									<form action="editLivestock.php" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
								<?php } ?>
                                        <div class="form-row">
											<div class="form-group col-md-4">
                                                <select class="custom-select mr-sm-2" name="livestock_type" id="livestock_type">
                                                    <option value="">Livestock type...</option>
                                                    <option value="cattle" <?php if($livestock_type=="cattle"){ echo 'selected="selected"'; } ?>>cattle</option>
                                                    <option value="sheep" <?php if($livestock_type=="sheep"){ echo 'selected="selected"'; } ?>>sheep</option>
                                                    <option value="pigs" <?php if($livestock_type=="pigs"){ echo 'selected="selected"'; } ?>>pigs</option>
													<option value="goats" <?php if($livestock_type=="goats"){ echo 'selected="selected"'; } ?>>goats</option>
													<option value="donkeys" <?php if($livestock_type=="donkeys"){ echo 'selected="selected"'; } ?>>donkeys</option>
                                                </select>
                                            </div>
											<div class="form-group col-md-4">
										...
										<div class="form-row mb-2">
													...
													<div class="col-auto my-1">
														<label>Asset Source <span class="text-danger">*</span></label>
										...
										<div class="form-row mb-2 ">
											...
											<div class="col-auto">
												<input type="date" class="form-control" name="date_of_acquisition" id="date_of_acquisition" value="<?php echo $date_of_acquisition; ?>" required />
                                            </div>
										</div>
										...
										<div class="form-row">
                                            ...
                                            <div class="col-auto my-1">
												<label>Estimated Spent Amount <span class="text-danger">*</span></label>
										...
										<input type="hidden" name="livestock_declaration_id" value="<?php echo $livestock_declaration_id; ?>" />
