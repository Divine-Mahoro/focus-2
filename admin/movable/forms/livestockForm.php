                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="<?php echo $main_link; ?>?dir=movable&page=livestock" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
										...
										<div class="form-row mb-2">
                                            <div class="col-auto my-1">
												...
												<input type="text" class="form-control" name="estimated_spent_amount" id="estimated_spent_amount" placeholder="Spent Amount" required />
                                            </div>
											<div class="col-auto my-1">
												<label>Estimated Income <span class="text-danger">*</span></label>
												<input type="text" class="form-control" name="estimated_income" id="estimated_income" placeholder="Estimated Income" required />
                                            </div>
                                        </div>
