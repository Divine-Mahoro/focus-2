                    ...
                    <div class="col-xl-6 col-xxl-12"> 
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Other Movable Declaration</h4>
								<?php 
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="<?php echo $main_link; ?>?dir=movable&page=otherMovable" method="POST" name="rsForm" id="rsForm"
									onsubmit="return getDetails();">
                                        <div class="form-row">
											<div class="form-group col-md-4">
												<input type="text" class="form-control" name="movable_type" id="movable_type" placeholder="Movable Type">
										   	</div>
										...
										<div class="form-row mb-2 ">
											...
											<div class="col-auto">
												<input type="date" class="form-control" name="date_of_acquisition" id="date_of_acquisition" placeholder="yyyy-mm-dd" required />
                                            </div>
										</div>
										...
										<div class="form-row mb-2">
                                            <div class="col-auto my-1">
												...
												<input type="text" class="form-control" name="estimated_spent_amount" id="estimated_spent_amount" placeholder="Estimated value" required />
                                            </div>
											<div class="col-auto my-1">
												<label>Estimated Income <span class="text-danger">*</span></label>
												<input type="text" class="form-control" name="estimated_income" id="estimated_income" placeholder="Asset source" required />
                                            </div>
                                        </div>
		...
		function getDetails(){
			...
			if (document.forms[0]['livestock_type'].value == 0) {
				alert("Please Select Livestock Type");
				return false;
			}
