                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="editYearlySoldAsset.php" method="POST" name="rsForm" id="rsForm"
                                        ...
                                        <div class="form-row">
											...
											<div class="form-group col-md-2" id="loan_clear_date">
												<input type="text" class="form-control" name="earned_amount" id="earned_amount" value="<?php echo $earned_amount; ?>" required>
                                            </div>
                                            
                                        </div>
										<input type="hidden" name="sold_asset_id" value="<?php echo $sold_asset_id; ?>" />
