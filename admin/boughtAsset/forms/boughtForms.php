                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="<?php echo $main_link; ?>?dir=boughtAsset&page=bought" method="POST" name="rsForm" id="rsForm"
                                        ...
                                        <div class="form-row">
											...
											<div class="form-group col-md-2" id="loan_clear_date">
												<input type="text" class="form-control" name="spent_amount" id="earned_amount" placeholder="Spent money" required>
                                            </div>
