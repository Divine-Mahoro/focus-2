                    ...
                    <div class="col-xl-6 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Bought Asset Yearly Declaration</h4>
                                <?php 
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="editBought.php" method="POST" name="rsForm" id="rsForm"
									    onsubmit="return getDetails();">
                                        <div class="form-row">
											<div class="form-group col-md-2" id="loan_clear_date">
												<input type="text" class="form-control" name="asset_type" id="asset_type" value="<?php echo $asset_type; ?>" required>
                                            </div>
											...
											<div class="form-group col-md-2" id="loan_clear_date">
												<input type="text" class="form-control" name="spent_amount" id="earned_amount" value="<?php echo $spent_amount; ?>" required>
                                            </div>
                                            
                                        </div>
										
										<input type="hidden" name="bought_asset_id" value="<?php echo $bought_asset_id; ?>" />
