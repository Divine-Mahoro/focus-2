<?php 
                ...
                if(isset($_POST['btnSubmit'])){
                    ...
                    $spent_amount = prepare_input($_POST['spent_amount']);

                    $tableName = "bought_asset";
	                $fieldsNames = array(
                                    "employee_id",
												...
												<tbody>
													<?php 
														while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
															...
															echo '<td>';
															echo '<a href="editBought.php?edit='.$id.'"><i class="fa fa-pencil text-dark" aria-hidden="true"></i></a>&nbsp;&nbsp;';
															echo '<a href="./pages/boughtAsset/deleteBought.php?delete='.$id.'" onclick="return confirm(\'Are you sure you want to delete this record?\');"><i class="fa fa-trash text-danger" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';													
															echo '</td>';
															echo '</tr>';
														}
