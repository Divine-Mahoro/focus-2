        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li><a href="<?php echo $main_link; ?>?dir=hod&page=approveStudent" aria-expanded="false"><i
                                class="bi-card-list"></i><span class="nav-text">Approve Reported Student<span class="badge badge-warning ml-1"><?php echo $resultSold; ?></span></span></a></li>
